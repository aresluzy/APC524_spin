...
def main():
    ...
    XYPlotter.plot_observables(improved_results, L_list, T_list)
    XYPlotter.plot_spin_orientations(improved_results, 8, 1.5)
    XYPlotter.create_spin_orientation_gif(improved_results, 8, T_list, 500, output_file="spin_orientations.gif")
