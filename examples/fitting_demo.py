...
def main():
    ...
    #uncomment blocks as you wish to start individual fitting you want
    ...
    # print("Tc: ", Tc)
    #
    # DataCollapsePlotter.data_collapse_magnetization(improved_results, T_list, L_list, Tc, alpha, nu, plot=True)
    # DataCollapsePlotter.data_collapse_susceptibility(improved_results, T_list, L_list, Tc, gamma, nu, plot=True)
    # DataCollapsePlotter.data_collapse_specific_heat(improved_results, T_list, L_list, Tc, beta, nu, plot=True)
    #
